...
> **⚠️ Note to Judges:**
> These videos are hosted on **Google Drive** because YouTube's automated moderation system incorrectly flagged the synthetic/dummy patient data shown in the demo as "Personally Identifiable Information".
> **No real data exists in this project.** All names and phones shown are generated by software (Faker).
>
...
### 2. Technical Deep Dive (26 min) - OPTIONAL

[![Technical Documentation Video](https://img.youtube.com/vi/ZGjs8cYaYCI/maxresdefault.jpg)](https://drive.google.com/file/d/1t8ktmXoMRhvQ3heGQ0ce__tc92AJlfVu/view?usp=sharing)

**For:** Judges & Developers

**[▶️ Watch Technical Presentation on Google Drive](https://drive.google.com/file/d/1t8ktmXoMRhvQ3heGQ0ce__tc92AJlfVu/view?usp=sharing)**
*Detailed walkthrough of Architecture, KMP implementation, and Codebase.*
