...
class ApiClient(
    ...
    val httpClient = HttpClient {
        ...
        install(HttpTimeout) {
            requestTimeoutMillis = 60_000   // 60 seconds - tolerate Render cold start
            connectTimeoutMillis = 60_000   // 60 seconds connect timeout
            socketTimeoutMillis = 60_000    // 60 seconds socket timeout
        }
